...
internal class TrimPanel(
    ...
    private val thumbTrackWidth: Float get() = panelWidth - MysticChinaTheme.Spacing.lg * 2
...
internal fun ViewContainer<*, *>.TrimPanelView(
    ...
    val trackW = pageWidth - MysticChinaTheme.Spacing.lg * 2
    val handleSize = 24f
    val trackH = 56f
    val thumbH = 44f
        ...
        View {
            ...
            Text {
                attr {
                    ...
                    fontSize(12f)
                    color(MysticChinaColors.primary)
                }
            }
        ...
        View {
            ...
            View {
                ...
                Text {
                    attr {
                        text("取消")
                        fontSize(14f); color(MysticChinaColors.textSecondary)
                    }
                }
            }
            ...
            View {
                ...
                Text {
                    attr {
                        text("确认裁剪")
                        fontSize(14f); color(MysticChinaColors.textPrimary)
                        fontWeightSemiBold()
                    }
                }
            }
