...
internal class ProgressBarAttr : ComposeAttr() {
    ...
    var trackColor: Color = MysticChinaColors.progressTrack
    var fillColor: Color = MysticChinaColors.progressFill
    var thumbColor: Color = MysticChinaColors.progressThumb
    var showThumb: Boolean = true
    var barHeight: Float = MysticChinaTheme.BarHeight.progressBar
