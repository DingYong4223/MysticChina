...
internal class TopBarView : ComposeView<TopBarAttr, TopBarEvent>() {
    ...
    override fun body(): ViewBuilder {
        ...
        return {
            View {
                attr {
                    size(pagerData.pageViewWidth, MysticChinaTheme.BarHeight.topBar + pagerData.statusBarHeight)
                ...
                Text {
                    attr {
                        ...
                        fontWeightBold()
                        textAlignCenter()
                        marginRight(if (ctx.attr.showBack) MysticChinaTheme.BarHeight.topBar else 0f)
                    }
                }
            }
        }
