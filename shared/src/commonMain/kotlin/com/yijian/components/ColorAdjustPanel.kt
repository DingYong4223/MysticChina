...
import com.yijian.model.ColorAdjustment
...
internal fun ViewContainer<*, *>.ColorAdjustView(ctx: ColorAdjustPanel) {
    View {
        ...
        View {
            ...
            Text {
                attr { text("调节"); fontSize(16f); color(YijianColors.textPrimary); fontWeightSemiBold() }
            }
            View {
                ...
                View {
                    ...
                    View {
                        ...
                        View {
                            attr {
                                ...
                                borderRadius(3f)
                                backgroundColor(if (isSelected) YijianColors.primary else YijianColors.textTertiary)
                    ...
                    Text {
                        attr {
                            text(item.label)
                            fontSize(10f)
                            color(if (isSelected) YijianColors.primary else YijianColors.textTertiary)
                            textAlignCenter()
                            marginTop(2f)
                        }
                    }
    ...
    View {
        ...
        Text {
            attr {
                ...
                fontSize(10f); color(YijianColors.textTertiary)
